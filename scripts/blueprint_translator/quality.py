...
ARK_PARENT_OR_RPC_NAMES = {
    ...
    "isspectator",
    "issubmerged",
    "iswildfollowerotherwisevalidandliving",
    "iswildslow",
    "isimprintplayer",
    "isclient",
    "isrunningonserver",
    ...
    "multicastproperty",
    "netsyncbufflifetime",
    "netsetmaxtamingeffectivenessbaselevelmultiplier",
    "staticaddbuff",
    ...
    "applydamage",
    "cumulativeadjustfloatvaluefromcharactertraits",
    "getdragweight",
...
COMPONENT_OR_PRESENTATION_NAMES = {
    ...
    "startclosingwidget",
    "stop",
    "sync minigame widget",
    "try trigger win",
    "addtoaggro",
    "getaggrodesirability",
}
...
def collect_asset_quality(asset_payload: dict[str, object]) -> dict[str, object]:
    ...
    for graph in asset_payload.get("graphs", []):
        ...
        empty_graph = bool(graph.get("empty_graph")) or node_count == 0
        row = {
            "graph": graph_name,
            "type": current_type,
            ...
            "missing_entry_points": 0 if empty_graph else count_diagnostic_value(diagnostics.get("missing_entry_points", [])),
        }
