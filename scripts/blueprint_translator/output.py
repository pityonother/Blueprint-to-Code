...
def resolve_output_paths(args: argparse.Namespace, compare: bool = False) -> dict[str, Path]:
    ...
    return {
        ...
        "context_review": out_dir / "context_review.md",
        "context_review_json": out_dir / "context_review.json",
        "formula_candidates": out_dir / "formula_candidates.md",
        "formula_candidates_json": out_dir / "formula_candidates.json",
        "asset_memory_card": out_dir / "asset_memory_card.md",
        "asset_memory_card_json": out_dir / "asset_memory_card.json",
        "context_pack": out_dir / "context_pack.md",
        "context_pack_json": out_dir / "context_pack.json",
        ...
        "call_graph_summary": out_dir / "call_graph_summary.md",
